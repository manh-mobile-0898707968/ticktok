...
banner = f"""
{Fore.WHITE}════════════════════════════════════════════════════
{Fore.RED}  Manhmobile-TOOLS    {Fore.WHITE}Phiên Bản: {Fore.YELLOW}Authorization-GOLIKE-TIKTOK 
{Fore.WHITE}════════════════════════════════════════════════════
{Fore.WHITE}[{Fore.RED}⚡{Fore.WHITE}]{Fore.WHITE} Admin{Fore.WHITE}: \033[38;2;0;220;255 LLê Văn Mạnh
{Fore.WHITE}[{Fore.RED}⚡{Fore.WHITE}]{Fore.WHITE} facebook{Fore.WHITE}: \033[38;2;0;220;255mhttps://www.facebook.com/levan.manh.739978/
{Fore.WHITE}[{Fore.RED}⚡{Fore.WHITE}]{Fore.WHITE} TikTok{Fore.WHITE}: \033[38;2;0;220;255https://www.tiktok.com/@manhmobileyb?lang=en-GB
{Fore.WHITE}[{Fore.RED}⚡{Fore.WHITE}]{Fore.WHITE} Bán full src 90k{Fore.WHITE}: \033[38;2;0;220;255mLH:0898707968
{Fore.WHITE}════════════════════════════════════════════════════
"""
...
while True:
    ...
    for remaining_time in range(delay, -1, -1):
        ...
        print(f"\r{color}🚀|TOOL-v1| {remaining_time}s           ", end="")
        time.sleep(1)
